...
module kb_cocacola {
    ...
    */
    ...
    /*
        result_folder: folder path that holds all files generated by run_kb_cocacola
    ...
    */
    ...
    funcdef run_kb_cocacola(CocacolaInputParams params)
        returns (CocacolaResult returnVal) authentication required;
